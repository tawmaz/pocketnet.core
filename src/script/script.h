...
#ifndef POCKETCOIN_SCRIPT_SCRIPT_H
#define POCKETCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Pocketcoin always counted CHECKMULTISIGs
...
#endif // POCKETCOIN_SCRIPT_SCRIPT_H
