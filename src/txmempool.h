...
#ifndef POCKETCOIN_TXMEMPOOL_H
#define POCKETCOIN_TXMEMPOOL_H
...
enum class MemPoolRemovalReason {
    UNKNOWN = 0, //! Manually removed or unknown reason 0 
    EXPIRY,      //! Expired from mempool - 1
    SIZELIMIT,   //! Removed in size limiting - 2
